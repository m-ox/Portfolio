...
export default class BlogForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            content: '',
            featured_image: '',
            apiUrl: 'https://mox.devcamp.space/portfolio/portfolio_blogs',
            apiAction: 'post'
        }
        ...
        console.log('BlogForm props', this.props)
    }
    ...
    componentDidMount() {
      if (this.props.editMode) {
        this.setState({
          ...
          apiUrl: `https://mox.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
          apiAction: 'patch'
        })
      }
    }
        ...
        return (
            <form onSubmit={this.handleSubmit} className="blog-form-wrapper">
                ...
                <div className='finish-button-wrapper'>
                  <button onSubmit={this.handleSubmit} className="button finishdoc">Finish Document</button>
                </div>
            </form>
        )
    }
